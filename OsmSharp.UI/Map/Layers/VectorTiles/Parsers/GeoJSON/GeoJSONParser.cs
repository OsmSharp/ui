...
{
    /// <summary>
    /// A parser for GeoJSON vector tiles into an OsmSharp scene object.
    /// </summary>
    public class GeoJSONParser : IVectorTileParser
    {
        /// <summary>
        /// Holds the projection the GeoJSON-data is in.
        /// </summary>
        private IProjection _projection;

        /// <summary>
        /// Creates a new GeoJSON parser.
        /// </summary>
