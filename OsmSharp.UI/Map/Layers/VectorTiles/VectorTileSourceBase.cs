...
namespace OsmSharp.UI.Map.Layers.VectorTiles
{
    ...
    public abstract class VectorTileSourceBase : IVectorTileSource
    {
        ...
        private readonly LRUCache<ulong, Scene2D> _cache; // the cached tiles.
        ...
        /// </summary>
        public bool TryGet(Tile tile, out Scene2D scene)
        {
        ...
        /// </summary>
        public bool TryPeek(Tile tile, out Scene2D scene)
        {
        ...
        /// </summary>
        protected abstract Scene2D Get(Tile tile, Stream stream);
