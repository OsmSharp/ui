...
namespace OsmSharp.UI.Map.Layers
{
    ...
    /// A tile layer.
    /// </summary>
    public class OldLayerTile : Layer, IComparer<Primitive2D>, IDisposable
    {
        /// <summary>
        /// Holds the tile url.
        /// </summary>
        ...
        public OldLayerTile(string tilesURL)
            : this(tilesURL, 160)
        {
        ...
        public OldLayerTile(string tilesURL, int tileCacheSize)
        {
