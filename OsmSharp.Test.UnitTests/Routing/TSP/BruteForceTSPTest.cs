...
//                Assembly.GetExecutingAssembly().GetManifestResourceStream("OsmSharp.Test.Unittests.test_tsp_5.tsp")));
...
//            // load the problem.
//            OsmSharp.TSPLIB.Problems.TSPLIBProblem problem = TSPLIBProblemParser.ParseFrom(new StreamReader(
//                Assembly.GetExecutingAssembly().GetManifestResourceStream("OsmSharp.Test.Unittests.test_tsp_6.tsp")));
