...
{
    /// <summary>
    /// Contains test for the Vehicle.Bicycle class.
    /// </summary>
    [TestFixture]
    public class VehicleBicycleTests : VehicleBaseTests
    {
        /// <summary>
        /// Tests the can traverse functionality.
        /// </summary>
        [Test]
        public void TestVehicleBicycleCanTranverse()
        {
            ...
            // designated roads.
            base.TestVehicleCanTranverse(vehicle, false, "highway", "unclassified", "foot", "designated");
            ...
            base.TestVehicleCanTranverse(vehicle, false, "highway", "unclassified", "bicycle", "no");
        }
        ...
        /// </summary>
        [Test]
        public void TestVehicleBicycleMaxSpeed()
        {
            Vehicle vehicle = Vehicle.Bicycle;
        ...
        /// </summary>
        [Test]
        public void TestVehicleBicycleProbableSpeed()
        {
            Vehicle vehicle = Vehicle.Bicycle;
            double max = 15;
