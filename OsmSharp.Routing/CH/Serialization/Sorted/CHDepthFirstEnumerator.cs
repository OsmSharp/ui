...
namespace OsmSharp.Routing.CH.Serialization.Sorted
{
    ...
    //        {
    //            uint highest = 1;
    //            var arcs = new List<Edge<CHEdgeData>>(_graph.GetEdges(highest));
    //            while (arcs.Count > 0)
    //            {
    //                highest = arcs[0].Neighbour;
    //                arcs = new List<Edge<CHEdgeData>>(_graph.GetEdges(highest));
    //            }
    ...
    //                    var arcs = new List<Edge<CHEdgeData>>(_graph.GetEdges(vertex));
    //                    while (arcs.Count > 0)
    //                    {
    //                        vertex = arcs[0].Neighbour;
    //                        arcs = new List<Edge<CHEdgeData>>(_graph.GetEdges(vertex));
    //                    }
    //                    _index.Add(vertex);
    //                    _currentCount++;
