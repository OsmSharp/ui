...
using OsmSharp.Routing.Optimization.VRP.NoDepot.MaxTime.Genetic.Mutation;
...
//            _customers = problem.Customers;
            ...
            //                 true));
            //IRoute tsp_solution = tsp_solver.Solve(new OsmSharp.Routing.Optimization.VRP.NoDepot.MaxTime.TSPPlacement.TSPProblem(
            //    problem));
            ...
            IGenerationOperation<MaxTimeSolution, MaxTimeProblem, Fitness> generation =
                ...
                new OsmSharp.Routing.Optimization.VRP.NoDepot.MaxTime.Genetic.Generation.RandomBestPlacement();
            ...
            ICrossOverOperation<MaxTimeSolution, MaxTimeProblem, Fitness> cross_over =
                new OsmSharp.Routing.Optimization.VRP.NoDepot.MaxTime.Genetic.CrossOver.RouteExchangeOperation();
