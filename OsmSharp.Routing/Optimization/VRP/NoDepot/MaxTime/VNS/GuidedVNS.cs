...
using OsmSharp.Routing.Optimization.VRP.NoDepot.MaxTime.CheapestInsertion;
...
namespace OsmSharp.Routing.Optimization.VRP.NoDepot.MaxTime.VNS
{
    /// <summary>
                        ...
                        { // only check routes that overlap.
                            ...
                            { // keep trying to improve until the tau limit is exceeded.
                                ...
                                { // there is improvement!
                                    ...
                                    OsmSharp.Logging.Log.TraceEvent("OsmSharp.Routing.Optimization.VRP.NoDepot.MaxTime.VNS.GuidedVNS", TraceEventType.Information,
                                        "IMPROVEMENT: {0}->{1}",
