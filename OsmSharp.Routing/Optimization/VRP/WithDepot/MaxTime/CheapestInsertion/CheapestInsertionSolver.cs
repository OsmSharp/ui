...
namespace OsmSharp.Routing.Optimization.VRP.WithDepot.MaxTime.CheapestInsertion
{
    /// <summary>
            ...
            { // keep trying while there are still improvements.
                ...
                { // try the current improvement operations.
                    ...
                    { // there was an improvement.
                        OsmSharp.Logging.Log.TraceEvent("OsmSharp.Routing.Optimization.VRP.WithDepot.MaxTime.CheapestInsertion.CheapestInsertionSolver", TraceEventType.Information,
