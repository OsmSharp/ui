...
{
    /// <summary>
    /// An implementation of a write-only in-memory dynamic graph.
    /// </summary>
    public class MemoryDynamicGraphWriteOnly<TEdgeData> : IDynamicGraphWriteOnly<TEdgeData>
        where TEdgeData : IDynamicGraphEdgeData
    {
        ...
        /// </summary>
        public MemoryDynamicGraphWriteOnly()
            : this(1000)
        {
        ...
        /// Creates a new in-memory graph.
        /// </summary>
        public MemoryDynamicGraphWriteOnly(int sizeEstimate)
        {
            _nextVertexId = 1;
            _nextEdgeId = 0;
