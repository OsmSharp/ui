...
namespace TspApp.Main
{
    ...
    public partial class DemoForm : Form, IProgressReporter
    {
        ...
        private void DoTspCalculation(List<GeoCoordinate> points, VehicleEnum vehicle)
        {
            ...
            //RouterTSP<ResolvedPoint> router_tsp = 
            //    new Osm.Routing.Core.TSP.Genetic.RouterTSPGenetic<ResolvedPoint>(router);
            RouterTSP<ResolvedPoint> router_tsp =
                new Osm.Routing.Core.TSP.RandomizedArbitraryInsertion.RouteTSPRAI<ResolvedPoint>(router);
            ...
            try
            {
                ...
                //OsmSharpRoute result = router_tsp.CalculateTSP(nodes.ToArray());
                OsmSharpRoute result = router_tsp.CalculateTSP(nodes.ToArray(), false);
                _status_layer.Clear();
            ...
            catch (Osm.Routing.Core.Exceptions.RoutingException ex)
            {
                ...
                {
                    _status_layer.AddImage(global::Demo.TspDemo.Properties.Resources.flag_blue, point.Location);
                }
        ...
        {
            _points_layer.AddImage(global::Demo.TspDemo.Properties.Resources.house, point);
        ...
        public void Report(ProgressStatus status)
        {
            ...
            lblProgressMessage.Text = status.Message;
            progressBar.Value = (int)status.ProgressPercentage;
            progressBar.Refresh();
        }
    }
}