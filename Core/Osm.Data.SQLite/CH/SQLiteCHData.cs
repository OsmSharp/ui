...
//                    while (reader.Read())
//                    {
//                        CHVertex vertex = new CHVertex { Id = reader.GetInt64(0), 
//                            Latitude = (float) (reader.GetInt64(1) / 10000000.0),
//                            Longitude = (float)(reader.GetInt64(2) / 10000000.0), 
//                            Level = reader.IsDBNull(3)? int.MaxValue : reader.GetInt32(3)};
//                        GetNeighbours(vertex);
//                        yield return vertex;
//                    }
//                    reader.Close();
