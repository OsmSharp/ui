...
namespace OsmSharp.Routing.Graph.DynamicGraph
{
    ...
    /// </summary>
    public static class DynamicGraphExtensions
    {
        ///// <summary>
        ///// Returns only the forward edges of a graph.
        ///// </summary>
        ///// <typeparam name="EdgeData"></typeparam>
        ///// <param name="?"></param>
        ///// <returns></returns>
        //public static KeyValuePair<uint, EdgeData>[] GetArcsForward<EdgeData>(
        //    this IDynamicGraphReadOnly<EdgeData> graph)
