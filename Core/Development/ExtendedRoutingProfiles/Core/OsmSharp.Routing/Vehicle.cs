...
namespace OsmSharp.Routing
{
    ...
    public abstract class Vehicle
    {
        ...
        /// <returns></returns>
        protected bool TryGetHighwayType(IDictionary<string, string> tags, out string highwayType)
        {
        ...
        /// <param name="tags"></param>
        /// <returns></returns>
        public virtual bool CanTraverse(IDictionary<string, string> tags)
        {
            string highwayType;
        ...
        /// </summary>
        /// <returns></returns>
        public KilometerPerHour MaxSpeed(IDictionary<string, string> tags)
        {
        ...
        /// <returns></returns>
        public virtual bool IsEqualFor(IDictionary<string, string> tags1, Dictionary<string, string> tags2)
        {
        ...
        /// <param name="to"></param>
        /// <returns></returns>
        public virtual double Weight(IDictionary<string, string> tags, GeoCoordinate from, GeoCoordinate to)
        {
        ...
        /// <param name="tags"></param>
        /// <returns></returns>
        public virtual bool? IsOneWay(IDictionary<string, string> tags)
        {
            string oneway;
        ...
        /// <param name="tags"></param>
        /// <returns></returns>
        private string GetName(IDictionary<string, string> tags)
        {
        ...
        /// <param name="highwayType"></param>
        /// <returns></returns>
        protected abstract bool IsVehicleAllowed(IDictionary<string, string> tags, string highwayType);
    }
    ...
    public class Pedestrian : Vehicle
    {
        ...
        /// <param name="highwayType"></param>
        /// <returns></returns>
        protected override bool IsVehicleAllowed(IDictionary<string, string> tags, string highwayType)
        {
        ...
        /// <param name="tags"></param>
        /// <returns></returns>
        public override bool? IsOneWay(IDictionary<string, string> tags)
        {
            return null;
        }
    }
