...
namespace OsmSharp.Routing.Core.Route
{
    /// <summary>
    ...
    public class OsmSharpRoute
    {
        ...
        {
            OsmSharp.Routing.Core.Route.Gpx.OsmSharpRouteGpx.Save(file, this);
        }
        ...
        {
            OsmSharp.Routing.Core.Route.Kml.OsmSharpRouteKml.Save(file, this);
        }
        ...
        public static OsmSharpRoute Concatenate(OsmSharpRoute route1, OsmSharpRoute route2, bool clone)
        {
                ...
                end.Longitude == start.Longitude)
            {
                ...
                //// calculate metrics.
                //Routing.Core.Metrics.Time.TimeCalculator calculator = new OsmSharp.Routing.Core.Metrics.Time.TimeCalculator();
