...
//namespace OsmSharp.Routing.Core.VRP.WithDepot.MaxTime.CheapestInsertion
//{
//    /// <summary>
...
//                // start a route r.
//                IRoute current_route = new DepotRoute(solution.Add(customer));
...
//                        OsmSharp.Tools.Core.Output.OutputStreamHost.WriteLine("Intra-improvement found {0} {1}->{2}",
...
//                        OsmSharp.Tools.Core.Output.OutputStreamHost.WriteLine("Inter-improvement found {0}<->{1}: {2} ({3}->{4})",
...
//                        OsmSharp.Tools.Core.Output.OutputStreamHost.WriteLine("Inter-improvement found {0}<->{1}: {2}",
