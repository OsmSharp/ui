        ...
        private void ReadFromDocument()
        {
            if (!_read)
            {
                ...
                { // if there was no data to begin with.
                    if (osm.node != null)
                    {
                        foreach (Osm.Core.Xml.v0_6.node node in osm.node)
                        {
                    ...
                    if (osm.way != null)
                    {
                        foreach (Osm.Core.Xml.v0_6.way way in osm.way)
                        {
                    ...
                    {
                        foreach (Osm.Core.Xml.v0_6.relation relation in osm.relation)
                        {
