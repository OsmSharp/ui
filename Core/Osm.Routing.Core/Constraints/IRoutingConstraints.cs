...
namespace Osm.Routing.Core.Constraints
{
    ...
    public interface IRoutingConstraints
    {
        ...
        /// <returns></returns>
        IRoutingLabel GetLabelFor(ITaggedObject tagged_object);
        ...
        /// <returns></returns>
        bool ForwardSequenceAllowed(IList<IRoutingLabel> sequence, IRoutingLabel latest);
        ...
        /// <param name="sequence"></param>
        /// <returns></returns>
        bool BackwardSequenceAllowed(IList<IRoutingLabel> sequence, IRoutingLabel latest);
    }
}