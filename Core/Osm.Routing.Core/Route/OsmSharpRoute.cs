...
namespace Routing.Core.Route
{
    ...
    public class OsmSharpRoute
    {
        ...
        {
            Routing.Core.Route.Gpx.OsmSharpRouteGpx.Save(file, this);
        }
        ...
        {
            Routing.Core.Route.Kml.OsmSharpRouteKml.Save(file, this);
        }
        ...
        public static OsmSharpRoute Concatenate(OsmSharpRoute route1, OsmSharpRoute route2, bool clone)
        {
                ...
                end.Longitude == start.Longitude)
            {
                ...
                //// calculate metrics.
                //Routing.Core.Metrics.Time.TimeCalculator calculator = new Routing.Core.Metrics.Time.TimeCalculator();
