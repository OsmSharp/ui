...
namespace Osm.Routing.Core.Route
{
    ...
    public class OsmSharpRoute
    {
        ...
        {
            Osm.Routing.Core.Route.Gpx.OsmSharpRouteGpx.Save(file, this);
        }
        ...
        {
            Osm.Routing.Core.Route.Kml.OsmSharpRouteKml.Save(file, this);
        }
        ...
        public static OsmSharpRoute Concatenate(OsmSharpRoute route1, OsmSharpRoute route2, bool clone)
        {
                ...
                end.Longitude == start.Longitude)
            {
                ...
                //// calculate metrics.
                //Osm.Routing.Core.Metrics.Time.TimeCalculator calculator = new Osm.Routing.Core.Metrics.Time.TimeCalculator();
                //Dictionary<string, double> metrics = calculator.Calculate(route);
                //route.TotalDistance = metrics[Osm.Routing.Core.Metrics.Time.TimeCalculator.DISTANCE_KEY];
                //route.TotalTime = metrics[Osm.Routing.Core.Metrics.Time.TimeCalculator.TIME_KEY];
