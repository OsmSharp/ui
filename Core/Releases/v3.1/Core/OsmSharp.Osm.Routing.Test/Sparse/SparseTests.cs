...
//using OsmSharp.Osm.Data.Redis.Sparse;
//using OsmSharp.Osm.Data.XML.Processor;
//using OsmSharp.Routing.Osm.Core;
//using OsmSharp.Routing.Osm.Core.Route;
//using OsmSharp.Routing.Osm.Raw.Graphs.Interpreter;
//using OsmSharp.Routing.Osm.Sparse.Memory;
//using OsmSharp.Routing.Osm.Sparse.PreProcessor;
//using OsmSharp.Routing.Osm.Sparse.Processor;
//using OsmSharp.Routing.Osm.Sparse.Routing;
//using OsmSharp.Tools.Math.Geo;
//using OsmSharp.Tools.Xml.Sources;
//using OsmSharp.Routing.Osm.Core.Interpreter.Default;

//namespace OsmSharp.Routing.Osm.Test.Sparse
//{
//    /// <summary>
...
//                new OsmSharp.Osm.Xml.OsmDocument(new XmlFileSource(xml)));
//            OsmSharp.Routing.Osm.Raw.Router raw_router = new OsmSharp.Routing.Osm.Raw.Router(osm_data,
...
//            DataSet csv = OsmSharp.Tools.DelimitedFiles.DelimitedFileHandler.ReadDelimitedFile(null,
//                new System.IO.FileInfo(file), OsmSharp.Tools.DelimitedFiles.DelimiterType.DotCommaSeperated, true, true);
