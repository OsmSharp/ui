...
namespace OsmSharp.Osm.Data.XML.KmlSource
{
    /// <summary>
    ...
    public class KmlDataSource : IDataSourceReadOnly
    {
        ...
        private void ReadFromDocument()
        {
            if (!_read)
            {
                ...
                if (_document.Kml is OsmSharp.Xml.Kml.v2_1.KmlType)
                { // kml is v2.1.
                    OsmSharp.Xml.Kml.v2_1.KmlType kml = (_document.Kml as OsmSharp.Xml.Kml.v2_1.KmlType);

                    OsmGeo osm_geo = this.ConvertFeature(kml.Item);
                    this.AddOsmBase(osm_geo);
                } 
                else if(_document.Kml is OsmSharp.Xml.Kml.v2_0_response.kml)
                { // kml is a v2.0 response.
                    OsmSharp.Xml.Kml.v2_0_response.kml kml = (_document.Kml as OsmSharp.Xml.Kml.v2_0_response.kml);

                    if(kml.Item is OsmSharp.Xml.Kml.v2_0_response.Document)
                    {
                        OsmGeo osm_geo = this.ConvertDocument(kml.Item as OsmSharp.Xml.Kml.v2_0_response.Document);
                        this.AddOsmBase(osm_geo);
                    }
                    else if(kml.Item is OsmSharp.Xml.Kml.v2_0_response.Folder)
                    {
                        OsmGeo osm_geo = this.ConvertFolder(kml.Item as OsmSharp.Xml.Kml.v2_0_response.Folder);
                        this.AddOsmBase(osm_geo);
                    }
                    else if(kml.Item is OsmSharp.Xml.Kml.v2_0_response.Placemark)
                    {
                        OsmGeo osm_geo = this.ConvertPlacemark(kml.Item as OsmSharp.Xml.Kml.v2_0_response.Placemark);
                        this.AddOsmBase(osm_geo);
                    }
                    else if(kml.Item is OsmSharp.Xml.Kml.v2_0_response.Response)
                    {
                        OsmGeo osm_geo = this.ConvertResponse(kml.Item as OsmSharp.Xml.Kml.v2_0_response.Response);
                        this.AddOsmBase(osm_geo);
                    }
                }
                else if (_document.Kml is OsmSharp.Xml.Kml.v2_0.kml)
                { // kml is v2.0
                    OsmSharp.Xml.Kml.v2_0.kml kml = (_document.Kml as OsmSharp.Xml.Kml.v2_0.kml);

                    if (kml.Item is OsmSharp.Xml.Kml.v2_0.Document)
                    {
                        OsmGeo osm_geo = this.ConvertDocument(kml.Item as OsmSharp.Xml.Kml.v2_0.Document);
                        this.AddOsmBase(osm_geo);
                    }
                    else if (kml.Item is OsmSharp.Xml.Kml.v2_0.Folder)
                    {
                        OsmGeo osm_geo = this.ConvertFolder(kml.Item as OsmSharp.Xml.Kml.v2_0.Folder);
                        this.AddOsmBase(osm_geo);
                    }
                    else if (kml.Item is OsmSharp.Xml.Kml.v2_0.Placemark)
                    {
                        OsmGeo osm_geo = this.ConvertPlacemark(kml.Item as OsmSharp.Xml.Kml.v2_0.Placemark);
                        this.AddOsmBase(osm_geo);
                    }
                }
                else
            ...
            for (int idx = 0; idx < placemark.Items.Length; idx++)
            {
                ...
                switch (placemark.ItemsElementName[idx])
                {
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType1.LineString:
                        ...
                        member.Member = this.ConvertLineString(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0.LineString);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType1.MultiGeometry:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiGeometry(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0.MultiGeometry);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType1.MultiLineString:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiLineString(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0.MultiLineString);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType1.MultiPoint:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiPoint(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0.MultiPoint);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType1.MultiPolygon:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiPolygon(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0.MultiPolygon);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType1.Point:
                        member = new RelationMember();
                        member.Member = this.ConvertPoint(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0.Point);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType1.Polygon:
                        member = new RelationMember();
                        member.Member = this.ConvertPolygon(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0.Polygon);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                }
        ...
        /// <returns></returns>
        private OsmGeo ConvertMultiPolygon(OsmSharp.Xml.Kml.v2_0.MultiPolygon multiPolygon)
        {
        ...
        /// <returns></returns>
        private OsmGeo ConvertMultiPoint(OsmSharp.Xml.Kml.v2_0.MultiPoint multiPoint)
        {
        ...
        /// <returns></returns>
        private OsmGeo ConvertMultiLineString(OsmSharp.Xml.Kml.v2_0.MultiLineString multiLineString)
        {
            ...
            for (int idx = 0; idx < multiGeometry.Items.Length; idx++)
            {
                ...
                switch (multiGeometry.ItemsElementName[idx])
                {
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType.LineString:
                        member = new RelationMember();
                        member.Member = this.ConvertLineString(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0.LineString);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType.MultiGeometry:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiGeometry(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0.MultiGeometry);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType.MultiLineString:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiLineString(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0.MultiLineString);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType.MultiPoint:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiPoint(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0.MultiPoint);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType.MultiPolygon:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiPolygon(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0.MultiPolygon);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType.Point:
                        member = new RelationMember();
                        member.Member = this.ConvertPoint(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0.Point);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType.Polygon:
                        member = new RelationMember();
                        member.Member = this.ConvertPolygon(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0.Polygon);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                }
            ...
            for (int idx = 0; idx < folder.Items.Length; idx++)
            {
                ...
                switch (folder.ItemsElementName[idx])
                {
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType2.Document:
                        member = new RelationMember();
                        member.Member = this.ConvertDocument(folder.Items[idx] as OsmSharp.Xml.Kml.v2_0.Document);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType2.Folder:
                        member = new RelationMember();
                        member.Member = this.ConvertFolder(folder.Items[idx] as OsmSharp.Xml.Kml.v2_0.Folder);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType2.Placemark:
                        member = new RelationMember();
                        member.Member = this.ConvertPlacemark(folder.Items[idx] as OsmSharp.Xml.Kml.v2_0.Placemark);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                }
            ...
            for (int idx = 0; idx < document.Items.Length; idx++)
            {
                ...
                switch (document.ItemsElementName[idx])
                {
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType3.Document:
                        member = new RelationMember();
                        member.Member = this.ConvertDocument(document.Items[idx] as OsmSharp.Xml.Kml.v2_0.Document);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType3.Folder:
                        member = new RelationMember();
                        member.Member = this.ConvertFolder(document.Items[idx] as OsmSharp.Xml.Kml.v2_0.Folder);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0.ItemsChoiceType3.Placemark:
                        member = new RelationMember();
                        member.Member = this.ConvertPlacemark(document.Items[idx] as OsmSharp.Xml.Kml.v2_0.Placemark);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                }
        ...
        private OsmGeo ConvertResponse(OsmSharp.Xml.Kml.v2_0_response.Response response)
        {
            ...
            foreach (object item in response.Items)
            {
                ...
                {
                    OsmGeo osm_geo = this.ConvertDocument(item as OsmSharp.Xml.Kml.v2_0_response.Document);
                ...
                {
                    OsmGeo osm_geo = this.ConvertFolder(item as OsmSharp.Xml.Kml.v2_0_response.Folder);
                ...
                {
                    OsmGeo osm_geo = this.ConvertPlacemark(item as OsmSharp.Xml.Kml.v2_0_response.Placemark);
                ...
                {
                    OsmGeo osm_geo = this.ConvertResponse(item as OsmSharp.Xml.Kml.v2_0_response.Response);
            ...
            for(int idx = 0;idx < placemark.Items.Length;idx++)
            {
                ...
                switch (placemark.ItemsElementName[idx])
                {
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType1.LineString:
                        member = new RelationMember();
                        member.Member = this.ConvertLineString(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.LineString);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType1.MultiGeometry:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiGeometry(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.MultiGeometry);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType1.MultiLineString:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiLineString(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.MultiLineString);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType1.MultiPoint:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiPoint(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.MultiPoint);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType1.MultiPolygon:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiPolygon(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.MultiPolygon);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType1.Point:
                        member = new RelationMember();
                        member.Member = this.ConvertPoint(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.Point);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType1.Polygon:
                        member = new RelationMember();
                        member.Member = this.ConvertPolygon(placemark.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.Polygon);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                }
        ...
        /// <param name="multiPolygon"></param>
        /// <returns></returns>
        private OsmGeo ConvertMultiPolygon(OsmSharp.Xml.Kml.v2_0_response.MultiPolygon multiPolygon)
        {
            return this.ConvertPolygon(multiPolygon.Polygon);
        }
        ...
        /// <param name="multiPoint"></param>
        /// <returns></returns>
        private OsmGeo ConvertMultiPoint(OsmSharp.Xml.Kml.v2_0_response.MultiPoint multiPoint)
        {
            return this.ConvertPoint(multiPoint.Point);
        }
        ...
        /// <param name="multiLineString"></param>
        /// <returns></returns>
        private OsmGeo ConvertMultiLineString(OsmSharp.Xml.Kml.v2_0_response.MultiLineString multiLineString)
        {
            return this.ConvertLineString(multiLineString.LineString);
        }
            ...
            for (int idx = 0; idx < multiGeometry.Items.Length; idx++)
            {
                ...
                switch (multiGeometry.ItemsElementName[idx])
                {
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType.LineString:
                        member = new RelationMember();
                        member.Member = this.ConvertLineString(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.LineString);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType.MultiGeometry:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiGeometry(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.MultiGeometry);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType.MultiLineString:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiLineString(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.MultiLineString);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType.MultiPoint:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiPoint(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.MultiPoint);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType.MultiPolygon:
                        member = new RelationMember();
                        member.Member = this.ConvertMultiPolygon(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.MultiPolygon);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType.Point:
                        member = new RelationMember();
                        member.Member = this.ConvertPoint(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.Point);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType.Polygon:
                        member = new RelationMember();
                        member.Member = this.ConvertPolygon(multiGeometry.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.Polygon);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                }
            ...
            for (int idx = 0; idx < folder.Items.Length; idx++)
            {
                ...
                switch (folder.ItemsElementName[idx])
                {
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType2.Document:
                        member = new RelationMember();
                        member.Member = this.ConvertDocument(folder.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.Document);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType2.Folder:
                        member = new RelationMember();
                        member.Member = this.ConvertFolder(folder.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.Folder);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType2.Placemark:
                        member = new RelationMember();
                        member.Member = this.ConvertPlacemark(folder.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.Placemark);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                }
            ...
            for (int idx = 0; idx < document.Items.Length; idx++)
            {
                ...
                switch (document.ItemsElementName[idx])
                {
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType3.Document:
                        member = new RelationMember();
                        member.Member = this.ConvertDocument(document.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.Document);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType3.Folder:
                        member = new RelationMember();
                        member.Member = this.ConvertFolder(document.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.Folder);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                    case OsmSharp.Xml.Kml.v2_0_response.ItemsChoiceType3.Placemark:
                        member = new RelationMember();
                        member.Member = this.ConvertPlacemark(document.Items[idx] as OsmSharp.Xml.Kml.v2_0_response.Placemark);
                        member.Role = "";
                        relation.Members.Add(member);
                        break;
                }
        ...
        private IList<OsmGeo> ConvertFeatures(OsmSharp.Xml.Kml.v2_1.FeatureType[] featureType)
        {
        ...
        /// <returns></returns>
        private OsmGeo ConvertFeature(OsmSharp.Xml.Kml.v2_1.FeatureType feature)
        {
            if (feature is OsmSharp.Xml.Kml.v2_1.ContainerType)
            {
                return this.ConvertContainer(feature as OsmSharp.Xml.Kml.v2_1.ContainerType);
            }
            else if (feature is OsmSharp.Xml.Kml.v2_1.PlacemarkType)
            {
                return this.ConvertPlacemark(feature as OsmSharp.Xml.Kml.v2_1.PlacemarkType);
            }
            return null;
        }
        ...
        /// <param name="placemark"></param>
        /// <returns></returns>
        private OsmGeo ConvertPlacemark(OsmSharp.Xml.Kml.v2_1.PlacemarkType placemark)
        {
        ...
        /// <returns></returns>
        private OsmGeo ConvertGeometry(OsmSharp.Xml.Kml.v2_1.GeometryType geometry)
        {
            if (geometry is OsmSharp.Xml.Kml.v2_1.PointType)
            {
                return this.ConvertPoint(geometry as OsmSharp.Xml.Kml.v2_1.PointType);
                
            }
            else if (geometry is OsmSharp.Xml.Kml.v2_1.LineStringType)
            {
                return this.ConvertLineString(geometry as OsmSharp.Xml.Kml.v2_1.LineStringType);
            }
            else if (geometry is OsmSharp.Xml.Kml.v2_1.LinearRingType)
            {
                return this.ConvertLinearRing(geometry as OsmSharp.Xml.Kml.v2_1.LinearRingType);
            }
            else if (geometry is OsmSharp.Xml.Kml.v2_1.PolygonType)
            {
                return this.ConvertPolygon(geometry as OsmSharp.Xml.Kml.v2_1.PolygonType);
            }
            else if (geometry is OsmSharp.Xml.Kml.v2_1.MultiGeometryType)
            {
                return this.ConvertMultiGeometry(geometry as OsmSharp.Xml.Kml.v2_1.MultiGeometryType);
            }
            return null;
        }
        ...
        private Relation ConvertContainer(OsmSharp.Xml.Kml.v2_1.ContainerType container)
        {
            // get the features.
