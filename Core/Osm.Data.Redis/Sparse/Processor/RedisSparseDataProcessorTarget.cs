...
namespace Osm.Data.Redis.Sparse.Processor
{
    ...
    /// </summary>
    public class RedisSparseDataProcessorTarget : DataProcessorTarget
    {
        /// <summary>
        ...
        /// </summary>
        public RedisSparseDataProcessorTarget()
        {
        ...
        public RedisSparseDataProcessorTarget(string host, int port)
        {
        ...
        {
            throw new NotSupportedException("Changes are not supported in the redis target!");
        }
        ...
        {
            OsmNode new_node = PrimitiveExtensions.ConvertTo(node);
        ...
        public override void AddWay(SimpleWay way)
        {
            ...
            if (new_way.IsHighway)
            {
                ...
                foreach (long id in way.Nodes)
                {
                    ...
                    OsmNode new_node = _node_type_client.GetValue(OsmNode.BuildRedisKey(id));
        ...
        private HashSet<long> _processed_nodes;
        ...
        {
            //long node_idx = 0;
            //_processed_nodes = new HashSet<long>();
            ...
            //    _processed_nodes.Add(new_node.Id);
            //}
