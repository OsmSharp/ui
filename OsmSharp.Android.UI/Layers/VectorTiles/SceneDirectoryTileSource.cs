...
namespace OsmSharp.Android.UI.Layers.VectorTiles
{
    /// <summary>
    /// A tile source that reads tiles for a directory.
    /// </summary>
    public class SceneDirectoryTileSource : IVectorTileSource
    {
        private readonly string _path; // holds the path.
        ...
        /// </summary>
        public SceneDirectoryTileSource(string path)
        {
            _path = path;
        ...
        {
            OsmSharp.Logging.Log.TraceEvent("LayerVectorTiles", TraceEventType.Error, "Prepare");
            ...
            try
            {
                ...
                { // make sure that access to the queue is synchronized.
                    ...
                    { // there are queued items.
                        ...
                        var file = new FileInfo(string.Format(_path, tile.Zoom, tile.X, tile.Y));
        ...
        {
            OsmSharp.Logging.Log.TraceEvent("LayerVectorTiles", TraceEventType.Error, "TryGet");
        ...
        {
            OsmSharp.Logging.Log.TraceEvent("LayerVectorTiles", TraceEventType.Error, "TryPeek");
