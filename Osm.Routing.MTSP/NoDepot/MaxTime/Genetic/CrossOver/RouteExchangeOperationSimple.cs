...
//            for (int idx = route2.Count - 1 - (size - selected_from_source.Count) + 1;
//                idx <= route2.Count - 1; idx++)
//            {
...
//            MaxTimeSolution genome = new MaxTimeSolution();
...
//            genomes.Add(genome);
//            Individual<MaxTimeSolution, MaxTimeProblem, Fitness> individual = 
//                new Individual<MaxTimeSolution, MaxTimeProblem, Fitness>(genomes);
