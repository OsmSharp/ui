...
//            MaxTimeSolution multi_route = mutating.Genomes;
//            MaxTimeSolution genome = null;

//            if (multi_route.Count > 1)
//            { 
//                // select a route.
//                int source_route_idx = Tools.Math.Random.StaticRandomGenerator.Get().Generate(
//                    multi_route.Count);

//                // create a copy of the old genome without the source route.
//                int[] sizes = new int[multi_route.Count - 1];
//                int start_idx = multi_route.Route(source_route_idx).First;

//                int new_idx = 0;
//                for (int idx = 0; idx < multi_route.Count; idx++)
//                {
