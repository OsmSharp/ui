...
//        public GeoCoordinateBox AddRoute(OsmSharpRoute route, int? color)
//        {
//            return this.AddRoute(route, color, OsmSharpRouteLayer.DEFAULT_ROUTE_WIDTH);
//        }

//        public GeoCoordinateBox AddRoute(OsmSharpRoute route, int? color, int width)
//        {
//            if (route != null)
//            {
//                int route_color;
...
//        private GeoCoordinateBox DoForRoute(List<GeoCoordinate> route, double distance_arrow, int route_color, int width, int min_zoom, int max_zoom)
//        {
//            double distance = 0;
...
//                line.MinZoom = min_zoom;
//                line.MaxZoom = max_zoom;
//                line.EndCap = Drawing2D.LineCap.ArrowAnchor;
//                this.AddElement(line);
//            }
//            return new GeoCoordinateBox(route);
//        }

//        public void AddCustomRoute(List<GeoCoordinate> route, int? color, int width)
//        {
//            int route_color;
//            if (color != null && color.HasValue)
//            {
