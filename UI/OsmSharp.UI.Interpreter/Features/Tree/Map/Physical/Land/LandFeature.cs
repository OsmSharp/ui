...
namespace OsmSharp.Osm.Interpreter.Features.Tree.Map.Physical.Land
{
    ...
    public class LandFeature : Feature
    {
        ...
        private LandFeature(Filter filter, IDictionary<string, IList<string>> meta)
            : base("Map.ExistenceFeature.PhysicalFeature.LandFeature", filter, meta)
        {
        ...
        /// </summary>
        private static LandFeature _instance;
        ...
        {
            _instance = new LandFeature(filter, meta);
        }

        /// <summary>
        /// Returns the one and only instance of this feature.
        /// </summary>
        public static LandFeature Instance
        {
            get
            {
                return _instance;
