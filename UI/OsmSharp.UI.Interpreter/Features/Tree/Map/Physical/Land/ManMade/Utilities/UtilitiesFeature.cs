...
namespace OsmSharp.Osm.Interpreter.Features.Tree.Map.Physical.Land.ManMade.Power
{
    
    public class UtilitiesFeature : Feature
    {
        /// <summary>
        ...
        /// </summary>
        private static UtilitiesFeature _instance;
        ...
        {
            _instance = new UtilitiesFeature(filter, meta);
        }

        /// <summary>
        /// Returns the one and only instance of this feature.
        /// </summary>
        public static UtilitiesFeature Instance
        {
            get
            {
                return _instance;
