...
namespace OsmSharp.Osm.Interpreter.Features.Tree.Map.Physical.Land.Nature.Forest
{
    
    public class ForestFeature : Feature
    {
        /// <summary>
        ...
        /// </summary>
        private static ForestFeature _instance;
        ...
        {
            _instance = new ForestFeature(filter, meta);
        }

        /// <summary>
        /// Returns the one and only instance of this feature.
        /// </summary>
        public static ForestFeature Instance
        {
            get
            {
                return _instance;
