...
{    
    public class HamletFeature : Feature
    {
        /// <summary>
        ...
        private HamletFeature(Filter filter, IDictionary<string, IList<string>> meta)
            : base("Map.ExistenceFeature.AdministrativeFeature.PlaceFeature.HamletFeature", filter, meta)
        {
        ...
        /// </summary>
        private static HamletFeature _instance;
        ...
        {
            _instance = new HamletFeature(filter, meta);
        }

        /// <summary>
        /// Returns the one and only instance of this feature.
        /// </summary>
        public static HamletFeature Instance
        {
            get
            {
                return _instance;
